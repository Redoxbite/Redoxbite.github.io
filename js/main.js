(function () {
  ...
  document.querySelectorAll(".feature-card, .about-card, .product-card, .promise-item, .benefits-list, .gallery-item, .pdp__use-card, .pdp__faq-item").forEach(function (el) {
    el.style.opacity = "0";
